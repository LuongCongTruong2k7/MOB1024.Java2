...
public class VIPTicket extends Ticket {
	...
	public void setserviceFee(double serviceFee) {
		...
		if (serviceFee >= 0) {
			...
			do {
				System.out.print("serviceFee không được nhỏ hơn 0 vui lòng nhập lại: ");
	...
	public void setgiftComboPrice(double giftComboPrice) {
		...
		if (giftComboPrice >= 0) {
			...
			do {
				System.out.print("giftComboPrice không được nhỏ hơn 0 vui lòng nhập lại: ");
	...
	public String toString() {
		return "VIPTicket [id = " + getid() + ", movieName = " + getmovieName() + ", basePrice = " + getbasePrice()
				+ ", serviceFee = " + serviceFee + ", giftComboPrice = " + giftComboPrice + ", finalticketprice = "
				+ calculateTotal() + " ] ";
	}
}
